...
### 04/22/2019: the overall function for estimation
#******************************************************************************#
#******************************************************************************#
#                                                                              #
# Inputs                                                                       #
...
### 04/22/2019: the first part of the overall estimation. 
#******************************************************************************#
#******************************************************************************#
#                                                                              #
# Inputs                                                                       #
...
### 04/22/2019: the second part of the overall estimation. 
#******************************************************************************#
#******************************************************************************#
#                                                                              #
# Inputs                                                                       #
...
#====================================================================#
#=== other supporting functions for simulations studies =============#
#====================================================================#
### can be ignored in real application
...
###################################################################################################################
########################### the mean function when no time dependent confounders ##################################
###################################################################################################################
...
mr.part2.ind <- function(t.time, long.data){
  ...
  p2.sepa <- - sum(weight*OR.po.sepa*unlist(incre_c.surv_po))/sum(w)
  p2.correct <- - sum(weight*OR.po.correct*unlist(incre_c.surv_po))/sum(w)
  p2.SL <- - sum(weight*OR.po.SL*unlist(incre_c.surv_po))/sum(w)
...
mr.fun.ind <- function(test.time, long.data){
  ...
  mean.response.joint <- mean.response.sepa <- mean.response.correct <- 
    #part1.joint <- 
    part1.sepa <- part1.correct <- part2.sepa <- part2.correct <- p1.weight <- c()
